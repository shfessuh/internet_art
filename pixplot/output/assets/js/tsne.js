...
World.prototype.render = function() {
  ...
  // Animate each cell: drop until reaching the target y position
  data.cells.forEach(cell => {
      if (cell.dropDelay > 0) {
          // Decrement the delay (adjust the decrement value as needed)
          cell.dropDelay -= 0.02;
      } else if (cell.y > cell.ty) {
          cell.y -= 0.05; // Adjust fall speed as needed
          if (cell.y < cell.ty) {
              cell.y = cell.ty;
          }
      }
  ...
  // Update the BufferGeometry translation attribute for y values
  ...
  // Update controls, stats, LOD, lasso, etc.
  if (this.controls.type === 'trackball') {
    this.controls.update();
